...
import SBackButton from "../design-system/atom/iconButton/signupBackButton/SBackButton";

const meta: Meta<typeof SBackButton> = {
  title: 'Atom/IconButton/SignUpBackButton',
  component: SBackButton,
  tags: ['autodocs'],
  parameters: {
    layout: "centered",
  },
...
export default meta;
type Story = StoryObj<typeof SBackButton>;
